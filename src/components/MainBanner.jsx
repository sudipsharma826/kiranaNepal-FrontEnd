...
const MainBanner = () => {
  return (
    <div className='relative w-full h-[300px] md:h-[400px] lg:h-[420px] overflow-hidden rounded-4xl shadow-xl'>
      {/* Background Image */}
      <img 
      ...
      <div className='absolute inset-0 flex flex-col justify-center items-center px-4 md:px-16'>
        <div className='max-w-4xl mx-auto text-center relative z-10'>
          <h1 className='text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-6 tracking-tight leading-tight'>
            Welcome to{' '}
            <span className='text-yellow-400 animate-pulse'>Kirana</span>{' '}
