    ...
    <div className="bg-gradient-to-br from-orange-50 to-yellow-100 min-h-screen py-10 px-6 sm:px-12 lg:px-20">
      ...
      <div className="mt-16 text-center">
        <h2 className="text-2xl font-bold text-gray-700 mb-3 flex justify-center items-center gap-2">
          <Flame className="text-red-500" /> Limited Time Mega Discount!
        </h2>
        ...
        <button className="bg-red-500 hover:bg-red-600 text-white px-6 py-3 rounded-full text-lg shadow-md transition">
          Explore Restaurants
        </button>
      </div>
    </div>
